...
export class MinecraftAnimation extends CanvasAnimation {
    ...
    generateChunks(centerChunkX, centerChunkY) {
    ...
    initBlankCube() {
        ...
        this.blankCubeRenderPass.addAttribute("bVertPos", 4, this.ctx.FLOAT, false, 4 * Float32Array.BYTES_PER_ELEMENT, 0, undefined, this.cubeGeometry.positionsFlat());
        ...
        this.blankCubeRenderPass.addInstancedAttribute("cubeType", 1, this.ctx.FLOAT, false, Float32Array.BYTES_PER_ELEMENT, 0, undefined, new Float32Array(0));
        this.blankCubeRenderPass.addInstancedAttribute("pSeed", 1, this.ctx.FLOAT, false, Float32Array.BYTES_PER_ELEMENT, 0, undefined, new Float32Array(0));
        this.blankCubeRenderPass.addInstancedAttribute("horizon", 1, this.ctx.FLOAT, false, Float32Array.BYTES_PER_ELEMENT, 0, undefined, new Float32Array(0));
        ...
        this.distantCubeRenderPass.addAttribute("aVertPos", 4, this.ctx.FLOAT, false, 4 * Float32Array.BYTES_PER_ELEMENT, 0, undefined, this.distantCube.positionsFlat());
        this.distantCubeRenderPass.addAttribute("aNorm", 4, this.ctx.FLOAT, false, 4 * Float32Array.BYTES_PER_ELEMENT, 0, undefined, this.distantCube.normalsFlat());
        this.distantCubeRenderPass.addAttribute("aUV", 2, this.ctx.FLOAT, false, 2 * Float32Array.BYTES_PER_ELEMENT, 0, undefined, this.distantCube.uvFlat());
        this.distantCubeRenderPass.addInstancedAttribute("aOffset", 4, this.ctx.FLOAT, false, 4 * Float32Array.BYTES_PER_ELEMENT, 0, undefined, new Float32Array(0));
        this.distantCubeRenderPass.addInstancedAttribute("cubeType", 1, this.ctx.FLOAT, false, Float32Array.BYTES_PER_ELEMENT, 0, undefined, new Float32Array(0));
        this.distantCubeRenderPass.addInstancedAttribute("pSeed", 1, this.ctx.FLOAT, false, Float32Array.BYTES_PER_ELEMENT, 0, undefined, new Float32Array(0));
        this.distantCubeRenderPass.addUniform("uLightPos", (gl, loc) => {
            gl.uniform4fv(loc, this.lightPosition.xyzw);
        });
        this.distantCubeRenderPass.addUniform("uProj", (gl, loc) => {
            gl.uniformMatrix4fv(loc, false, new Float32Array(this.gui.projMatrix().all()));
        });
        this.distantCubeRenderPass.addUniform("uView", (gl, loc) => {
            gl.uniformMatrix4fv(loc, false, new Float32Array(this.gui.viewMatrix().all()));
        });
        this.distantCubeRenderPass.setDrawData(this.ctx.TRIANGLES, this.distantCube.indicesFlat().length, this.ctx.UNSIGNED_INT, 0);
        this.distantCubeRenderPass.setup();
    ...
    draw() {
        ...
        this.playerPosition.add(this.gui.walkDir().scale(10.0));
